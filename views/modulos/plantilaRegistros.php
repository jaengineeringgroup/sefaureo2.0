            ...
            <div class="contenidoFormulario">
                ...
                <div id="step-1" class="">
					...
					<div class="col-12 col-lg-6 col-sm-12 centrarBotones">
						<!-- <div class="btn-group col-lg-6 col-sm-12" role="group"> -->
							<button class="btn btn-warning btn-atras" id="prev-btn1" type="button" onclick="datosGenerales();"><</button>
                ...
                <div id="step-2" class="">
                    <div class="row">
						...
						<!--BOTONES DE SIGUIENTE Y ATRAS -->
							...
							<div class="btn-group col-lg-6 col-sm-12" role="group">
								<button class="btn btn-warning btn-atras" id="prev-btn2" type="button" onclick="direccion('#prev-btn2');"><</button>
                ...
                <div id="step-3" class="">
					<div class="row">
						...
						<!--BOTONES DE SIGUIENTE Y ATRAS -->
							...
							<div class="btn-group col-lg-6 col-sm-12" role="group">
								<button class="btn btn-warning btn-atras" id="prev-btn3" type="button" onclick="clientes();"><</button>
                ...
                <div id="step-4" class="">
						...
						<!--BOTONES DE SIGUIENTE Y ATRAS -->
							...
							<div class="btn-group col-lg-6 col-sm-12" role="group">
								<button class="btn btn-warning btn-atras" id="prev-btn4" type="button" onclick="descripcion();"><</button>
								<button class="btn btn-warning btn-siguiente" id="next-btn4" type="button" onclick="descripcion('#next-btn4');">Siguiente</button>
							</div>
						
						<!--TERMINAN OTONES DE SIGUIENTE Y ATRAS -->	
				</div>
            </div>
        </div>
